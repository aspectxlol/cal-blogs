      ...
      <section className="h-dvh w-full" ref={sectRef}>
        <div className="flex flex-col h-full justify-center text-center">
          <div className="flex flex-col justify-center items-center">
            ...
            <h1 className={`text-9xl font-extrabold ${InView ? "translate-x-0 opacity-100" : "-translate-x-48 opacity-0"} transition-all duration-500 max-w-5xl`}>The Worlds best<span className='bg-red-800 text-white duration-1000 ml-4'>Programmer</span></h1>
